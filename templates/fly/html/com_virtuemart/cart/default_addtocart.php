...
<div class="addtocart-area">
    ...
    <form method="post" class="js-recalculate product" action="index.php" >
...
<?php } else { ?>
		...
		<input type="text" class="quantity-input" name="quantity[]" value="<?php if (isset($this->product->min_order_level) && (int) $this->product->min_order_level > 0) {
