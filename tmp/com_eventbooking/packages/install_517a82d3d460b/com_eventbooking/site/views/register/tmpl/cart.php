...
?>
<h1 class="eb_title"><?php echo JText::_('EB_CHECKOUT'); ?></h1>
	...
	<table width="100%" class="os_table" cellspacing="3" cellpadding="3">
		...
		<tr>
			<td colspan="2" align="left">
				...
				<input type="button" class="btn btn-primary" name="btnSubmit" value="<?php echo  JText::_('EB_CHECKOUT_CONFIRMATION') ;?>" onclick="checkData();">				
			</td>
		</tr>										
	</table>					
	<?php
