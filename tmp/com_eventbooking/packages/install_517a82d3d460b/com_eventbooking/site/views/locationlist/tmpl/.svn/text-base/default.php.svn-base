...
<h1 class="eb_title"><?php echo JText::_('EB_LOCATIONS_MANAGEMENT'); ?>
	<span class="add_location_link" style="padding-left:25px; font-size: 16px;"><a href="<?php echo JRoute::_('index.php?option=com_eventbooking&task=add_location&Itemid='.JRequest::getInt('Itemid')) ; ?>"><?php echo JText::_('EB_SUBMIT_LOCATION') ; ?></a></span>
</h1>
<form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_eventbooking&view=locationlist&Itemid='.JRequest::getInt('Itemid'));; ?>">		  	
