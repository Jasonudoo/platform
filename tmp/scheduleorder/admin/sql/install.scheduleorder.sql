...
CREATE TABLE IF NOT EXISTS `#__schorder_cart` (
   ...
   `cart_currency` int(11) NOT NULL UNSIGNED DEFAULT '0',
   `created_by` int(11) NOT NULL UNSIGNED DEFAULT '0',
   `modified_by` int(11) NOT NULL UNSIGNED DEFAULT '0',
   `created_on` datetime DEFAULT NULL,
   `modified _on` datetime DEFAULT NULL,
   PRIMARY KEY (`cart_id`),
...
CREATE TABLE IF NOT EXISTS `#__schorder_cart_product` (
   ...
   `product_id` int(11) NOT NULL UNSIGNED DEFAULT '0',
...
INSERT INTO `#__so_categories` ('cid', 'parent', 'name', 'description', 'ordering', 'published')
VALUES('100001', '0', 'Vegetables', 'Vegetables Category', '1', '0'),
