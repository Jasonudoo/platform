...
/**
 * #__schorder_product_image table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTableProductImage extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTableProductImage
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_product_image', 'image_id', $db);
    }
