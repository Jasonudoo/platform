...
/**
 * #__schorder_cart_product table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTableCartProduct extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTableCartProduct
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_cart_product', 'cart_product_id', $db);
    }
