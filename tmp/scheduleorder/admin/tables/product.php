...
/**
 * #__schorder_product table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTableProduct extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTableProduct
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_product', 'product_id', $db);
    }
