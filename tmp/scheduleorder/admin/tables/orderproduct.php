...
/**
 * #__schorder_order_product table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTableOrderProduct extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTableOrderProduct
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_order_product', 'order_product_id', $db);
    }
