...
/**
 * #__schorder_product_package table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTableProductPackage extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTableProductPackage
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_product_package', 'product_package_id', $db);
    }
