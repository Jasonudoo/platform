...
/**
 * #__schorder_payment table.
 *
 * @package     Joomla
 * @subpackage  Schedule Order
 * @since       V1.0.0
 */
class ScheduleOrderTablePayment extends JTable
{
    /**
     * Constructor.
     *
     ...
     *
     * @return  ScheduleOrderTablePayment
     * @since   V1.0.0
     */
    public function __construct($db)
    {
        parent::__construct('#__schorder_payment', 'payment_id', $db);
    }
