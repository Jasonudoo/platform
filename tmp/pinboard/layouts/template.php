...
<body id="page" class="yoopage <?php echo $this->warp->config->get('leftcolumn'); ?> <?php echo $this->warp->config->get('rightcolumn'); ?> <?php echo $this->warp->config->get('itemcolor'); ?> <?php echo $this->warp->config->get('blog'); ?>">
